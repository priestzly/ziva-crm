          ...
          {!targetId && (
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 print:hidden animate-fade-in">
                ...
                <div className="flex gap-2">
                  <button 
                      onClick={exportToCSV}
                      className="flex-1 glass border-[hsl(var(--border))] rounded-xl flex items-center justify-center gap-2 text-xs font-black uppercase tracking-tight hover:bg-emerald-500/10 hover:text-emerald-500 transition-all"
                  >
                      <Download size={16} /> CSV
                  </button>
                  <button 
                      onClick={handlePrint}
                      className="flex-[2] btn-primary rounded-xl flex items-center justify-center gap-2 text-sm font-black uppercase tracking-tight"
                  >
          ...
          {!targetId && (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 print:hidden animate-fade-in delay-75">
                <div className="glass p-4 rounded-xl border-l-4 border-l-primary">
                    <p className="text-[10px] font-black text-muted-foreground uppercase opacity-60">Toplam Kayıt</p>
                ...
                <div className="glass p-4 rounded-xl border-l-4 border-l-amber-500">
                    <p className="text-[10px] font-black text-muted-foreground uppercase opacity-60">Toplam Maliyet</p>
                    <p className="text-xl font-black text-amber-500">
                        ...
                        }, 0).toLocaleString()} <span className="text-xs">TL</span>
                    </p>
                </div>
            </div>
          )}
